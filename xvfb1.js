  ...
  const cluster2 = await Cluster.launch({
    ...
    puppeteerOptions: {
      ...
      args: [
        ...
        '--disable-gpu',
                '--start-maximized', '--display='+xvfb2._display,
        `--disable-extensions-except=${pathToExtension1}`,
        `--load-extension=${pathToExtension1}`,
            '--enable-automation'
        ]
...
cluster2.on('taskerror', (err, data, willRetry) => {
    ...
    try {
      ...
      await page.goto("https://www.kartagotours.hu/keresesi-eredmenyek?d=63252|63447&dd=2024-05-01&nn=7|8|9|10|11|12|13|14&rd=2024-06-30&to=489|4371&tt=1", { waitUntil: 'networkidle2' });
